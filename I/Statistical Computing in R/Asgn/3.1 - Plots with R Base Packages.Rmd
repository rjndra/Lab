---
title: "Assignment 3.1 - Plots with R Base Packages"
...
**Advantages of plots created using R base packages:**<br>
* R base packages provide a wide range of plot types and options for customization.<br>
* R base plots can be generated quickly and easily, making them a good choice for exploratory data analysis and rapid prototyping.<br>
* R base plots can be easily embedded in reports and presentations, making them a useful tool for communication.<br>

**Limitations of plots created using R base packages:**<br>
* R base plots can be limited in terms of aesthetic appeal and customization options compared to more advanced plotting libraries.<br>
* R base plots may not be well-suited for complex visualizations or large datasets, as they may not be optimized for speed or memory usage.<br>
* The syntax for generating R base plots are difficult to learn for new users, especially for more complex plots.<br>
